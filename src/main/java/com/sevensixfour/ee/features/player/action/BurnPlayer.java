 ...
 */
public class BurnPlayer implements Feature {

    @Override
    public void enableFeature() {
        EightyEighty.instance.getWebserver().createContext("",
                new BurnPlayerHandler()
        );
    }
    ...
    private class BurnPlayerHandler extends WebserverHandler {
        public BurnPlayerHandler() {
            super();
            this.registerCheck(new RequiredPermissionCheck("player.action.burn"));
